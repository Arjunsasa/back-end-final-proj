...
<body>
<?php
    $allStudentQuery = DB::query("SELECT * FROM student WHERE studentEmail=%s", $_SESSION["studentEmail"]);
        ...
        <div class="col-md-7">  
            <div class="card p-3 py-4">
                <div class="text-center mt-3">
                    ...
                    <h5 class="mt-2 mb-0"><?php echo $allStudentName?></h5>
                    <span>Class: <?php echo $allStudentClass?></span>
                    <div class="px-4 mt-1">
                        <p class="fonts"><?php echo $allStudentDes?></p>
                        <p class="fonts">Contact no: <?php echo $allStudentPhone?></p>
                    </div>
                    ...
                    <div class="buttons">
                        ...
                        <button class="btn btn-outline-primary px-4 ms-3"><a class="" href="<?php echo SITE_ROOT; ?>quiz-table.php">Take Quiz</a></button>
                    </div>   
                </div>   
            </div>   
        </div>  
